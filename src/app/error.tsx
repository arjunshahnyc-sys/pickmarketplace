  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-8 bg-white">
      <div className="max-w-md text-center">
        ...
        {error.digest && (
          <p className="text-sm text-black/60 mb-8 font-mono">
        ...
        <div className="flex gap-4 justify-center">
          ...
          <a
            href="/"
            className="px-6 py-3 border border-black/10 text-black font-medium rounded-lg hover:bg-black/5 transition-colors"
          >
            Go Home
          </a>
        </div>
