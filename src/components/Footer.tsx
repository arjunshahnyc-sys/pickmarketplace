    ...
    <footer className="bg-white dark:bg-black border-t border-[var(--border)] mt-20">
      ...
      <section className="border-b border-[var(--border)] py-12 bg-gradient-to-b from-[var(--subtle-warm)] to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h3 className="text-center text-sm font-semibold text-[var(--muted)] uppercase tracking-[0.2em] mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-[var(--muted)]">Products Searched Daily</p>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-[var(--accent)] mb-2">
                <AnimatedCounter target={50} suffix="+" />
              </div>
              <p className="text-sm text-[var(--muted)]">Retailers Compared</p>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-[var(--accent)] mb-2">
                <AnimatedCounter target={2} prefix="$" suffix="M+" />
              </div>
              <p className="text-sm text-[var(--muted)]">Saved for Customers</p>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/how-it-works" className="text-sm text-[var(--muted)] hover:text-[var(--accent)] transition-colors">
                  How It Works
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/help" className="text-sm text-[var(--muted)] hover:text-[var(--accent)] transition-colors">
                  Help Center
                </Link>
              </li>
              <li>
                <Link href="/faq" className="text-sm text-[var(--muted)] hover:text-[var(--accent)] transition-colors">
                  FAQ
                </Link>
              </li>
              <li>
                <Link href="/retailers" className="text-sm text-[var(--muted)] hover:text-[var(--accent)] transition-colors">
                  Supported Retailers
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/compliance" className="text-sm text-[var(--muted)] hover:text-[var(--accent)] transition-colors">
                  Compliance
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="https://twitter.com/pickmarketplace" target="_blank" rel="noopener noreferrer" className="text-sm text-[var(--muted)] hover:text-[var(--accent)] transition-colors">
                  Twitter
                </a>
              </li>
              <li>
                <a href="https://facebook.com/pickmarketplace" target="_blank" rel="noopener noreferrer" className="text-sm text-[var(--muted)] hover:text-[var(--accent)] transition-colors">
                  Facebook
                </a>
              </li>
              <li>
                <a href="https://instagram.com/pickmarketplace" target="_blank" rel="noopener noreferrer" className="text-sm text-[var(--muted)] hover:text-[var(--accent)] transition-colors">
                  Instagram
                </a>
              </li>
              <li>
                <a href="mailto:support@pickmarketplace.com" className="text-sm text-[var(--muted)] hover:text-[var(--accent)] transition-colors">
                  Email Us
                </a>
              </li>
            </ul>
        ...
        <div className="pt-8 border-t border-[var(--border)] flex flex-col sm:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-[var(--foreground)]">Pick</span>
          </div>
          <p className="text-sm text-[var(--muted)]">
            © {new Date().getFullYear()} Pick Marketplace. All rights reserved.
          </p>
          <div className="flex gap-4">
            <a href="https://twitter.com/pickmarketplace" target="_blank" rel="noopener noreferrer" className="text-[var(--muted)] hover:text-[var(--accent)] transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" />
              </svg>
            </a>
            <a href="https://github.com/pickmarketplace" target="_blank" rel="noopener noreferrer" className="text-[var(--muted)] hover:text-[var(--accent)] transition-colors">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
