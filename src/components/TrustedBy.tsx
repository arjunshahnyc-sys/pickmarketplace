...
export function TrustedBy() {
  return (
    <section className="py-8 border-y border-gray-100 dark:border-white/10 bg-white/50 dark:bg-black/50">
      <p className="text-center text-xs text-gray-400 dark:text-white/40 uppercase tracking-[0.2em] mb-6 font-medium">
      ...
      <p className="text-center text-[11px] text-gray-300 dark:text-white/40 mt-4 uppercase tracking-[0.15em]">
